...
from utils.helpers import normalize_hierarchy_ranges
...
def extract_and_save_toc(filepath: str, base: str, page_offset: int = 0, max_toc_pages: int = 5):
    """
    High-level wrapper: extract TOC from PDF, normalize ranges, and save to JSON.
    Returns the hierarchy dict.
    """
    try:
        # Run your existing extraction
        toc_list, toc_page_number, _ = extract_and_correct_toc(filepath, page_offset, max_toc_pages)

        # Build hierarchy dict from toc_list
        hierarchy = {}
